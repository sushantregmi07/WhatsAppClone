...
val SurfaceLightGray = Color(0xFFF0F0F0)

// Text
val TextPrimary = Color(0xFF000000)
val TextSecondary = Color(0xFF8E8E93)

// Links & actions (iOS-style blue used throughout the design)
...
// Date chip
val DateChipBackground = Color(0x99DDDDE9) // ~60% alpha lavender-gray

// Swipe actions
val SwipeMoreGray = Color(0xFF8E8E93)
val SwipeArchiveBlue = Color(0xFF3E70A7)

// Action sheet
val ActionSheetGroupedSurface = Color(0xFFECECED)
val ActionSheetScrim = Color(0x80000000)

// Destructive & disabled
val DestructiveRed = Color(0xFFFF3B30)
val DisabledGray = Color(0xFFC7C7CC)
